...
void LoadResources()
{
	...
	textures->Add(ID_TEX_SIMON, L"textures\\simon.png",D3DCOLOR_XRGB(255, 255, 200));
	...
	// big
	sprites->Add(10001, 10, 3, 44, 64, texSimon);		// idle right
	sprites->Add(10002, 77, 2, 101, 63, texSimon);		// walk
	sprites->Add(10003, 135, 4, 166, 63, texSimon);
