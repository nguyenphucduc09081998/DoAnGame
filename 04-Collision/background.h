...
public:
	...
	static Background * GetInstance(int giaidoan, int ID_Background, LPCWSTR Path_Background_Image, D3DCOLOR Color_Background, LPCWSTR Path_TXR_Background, int chieudai_con);
